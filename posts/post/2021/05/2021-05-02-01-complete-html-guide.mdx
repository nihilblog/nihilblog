...
<Message color={'y'}>
  <p>HTML을 공부하기에 앞서 프로그래밍이란 무엇이고, 프로그래밍 언어는 무엇이며 웹과는 무슨 관련이 있는지를 다룬 <A href={'/post/2021-05-02-02-what-programing'} type='blog'>프로그래밍 공부를 시작하기 전에</A> 포스트를 먼저 보고 오시는 것을 추천드립니다.</p>
</Message>
