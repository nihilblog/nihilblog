...
<Message color='g'>
  <p>HTML에서 사용하는 탈출문자의 올바른 표현은 <Strong>엔티티 코드(Entity Code)</Strong>입니다.</p>
</Message>
...
![엔티티 코드를 사용한 모습이다.](https://drive.google.com/uc?export=view&id=1RfF1tkQVpIANn_1Zjb6KYa-RHTpOwj-3)
