...
export const BlogSeriesList = () => {
  ...
  return (
    <>
      <Box bottom='100'>
        <details css={style}>
          <summary onClick={onClickTitle}>모음 포스트 안내 {title}</summary>
          <div>
            <P>
            ...
            <P>
              모음을 확인하고 싶으시면 아래 중에서 원하는 <Strong>모음 열기</Strong>를 클릭하면 펼쳐집니다만, 익스플로러에선 어떻게 보일 지 모릅니다. 링크가 회색일 경우 아직 준비중인 링크이므로 확인하실 수 없습니다.
            </P>
