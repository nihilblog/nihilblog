      ...
      <BlogLayout meta={siteMeta}>
        <div id='blog-about-page'>
          <Box top='100'>
            ...
            <P>
              니힐로그는 제 닉네임을 따서 지었습니다. <Strong>니힐 + 블로그</Strong>라는 의미로 니힐의 블로그다 뭐 이런 의미로말이죠. 니힐로그는 웹 프로그래밍을 중점적으로 다룰 생각입니다. 이 블로그를 만들기 이전에는 네이버나 티스토리도 운영해봤습니다. 그런데 명색이 프로그래밍을 공부하는 사람인데 정작 자신의 손으로 구축한 블로그 하나 없어서야 되겠는가 싶어서 리액트의 프레임워크인 <A href='https://nextjs.org/' type='normal'>Next.js</A>로 구축했습니다.
            </P>
            <P bottom='0'>
